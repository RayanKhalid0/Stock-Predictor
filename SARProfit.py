...
stock_symbol = 'AMZN'  # You can change this to any stock symbol
stock_data = yf.download(stock_symbol, start='2023-01-01', end='2024-03-13')
...
for i in range(1, len(stock_data)):
    ...
    # Check if SAR crossed the stock price from below to above (potential sell signal)
